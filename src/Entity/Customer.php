...
class Customer
{
    ...
    public function getTotalAmount(): float {
        // Je fais une boucle sur mon tableau des invoices,
        // et accumuler mon montant des invoices
        // Je boucle donc sur mes invoices mais qui est un objet (ArrayCollection: classe qui enrichie un array),
        // Je le transforme donc en array
        return array_reduce($this->invoices->toArray(), function($total, $invoice) {
            return $total + $invoice->getAmount(); // je boucle sur les invoice et je rajoute à chaque fois le montant total
        }, 0); // total initialisé à 0
    }
